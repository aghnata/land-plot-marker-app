import { GCurrentLocationMarker, GMapContainer, GPlotMarker, GPlotPolygon } from '@/components/gmap';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/land-plots-gmap/create' },
];
...
export default function Create() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Land Plot - Google Maps" />
                ...
                <div className="w-full lg:w-96 lg:shrink-0">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Click on the map to define 4 boundary points.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <div className="relative min-h-[400px] flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border">
                    {geoLoading ? (
                        ...
                        <GMapContainer
                            center={getMapCenter()}
                            zoom={19}
                            onClick={boundaryPoints.length < 4 ? handleMapClick : undefined}
                        >
                            {latitude && longitude && (
                            ...
                            {boundaryPoints.length >= 3 && (
                                <GPlotPolygon points={boundaryPoints} />
                            )}
                        </GMapContainer>
                    )}
